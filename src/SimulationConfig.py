...
class Config:
    ...
    def read_from_xml(self,path_to_xml_file):
        ...
        self.gaussian_noise = float(config.find('gaussian_noise').text)
        ...
        assert self.gaussian_noise >= 0.0
        ...
        assert self.min_vertical_angle_deg > -90
        assert self.max_vertical_angle_deg < 90
